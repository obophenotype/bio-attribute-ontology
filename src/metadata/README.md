 ...
 * [oba.yml](oba.yml)
     * Determines how your purl.obolibrary.org/obo/oba/ redirects will be handled
     ...
     * Paste in the contents of [oba.yml](oba.yml)
 ...
 * [oba.md](oba.md)
     ...
     * Paste in the contents of [oba.md](oba.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
