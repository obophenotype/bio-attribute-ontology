...
Now add a new goal in your custom Makefile (`src/ontology/oba.Makefile`, _not_ `src/ontology/Makefile`).
...
1. Providing an additional attribute for the component in `src/ontology/oba-odk.yaml`, `source`,
